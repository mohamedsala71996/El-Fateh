                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('phone-numbers.store') }}">
                            ...
                            <div class="form-group mb-4">
                                ...
                                <input id="ar_title" type="text" class="form-control @error('ar_title') is-invalid @enderror" name="ar_title" value="{{ old('ar_title') }}" required autocomplete="ar_title">
                            ...
                            <div class="form-group mb-4">
                                ...
                                <select id="branch_id" class="form-control @error('branch_id') is-invalid @enderror" name="branch_id">
                                    ...
                                    <option value="0">{{ $mainBranch->en_address }} (main branch)</option>
                                    @foreach($branches as $branch)
                                        <option value="{{ $branch->id }}">{{ $branch->en_address }}</option>
                                    @endforeach
                                </select>
