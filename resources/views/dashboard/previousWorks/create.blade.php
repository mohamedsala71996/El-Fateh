        ...
        <div class="container-fluid">
            ...
            <div>
                <div>
                    <div>
                        <div class="card">
                            <div class="card-header">{{ __('Add Previous Work') }}</div>
                            ...
                            <div class="card-body">
                                <form method="POST" action="{{ route('previousWorks.store') }}" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group mb-4">
                                        ...
                                        <input id="en_engineer_name" type="text"
                                            class="form-control @error('en_engineer_name') is-invalid @enderror"
                                            name="en_engineer_name" value="{{ old('en_engineer_name') }}" required
                                            autocomplete="en_engineer_name" autofocus>
                                    ...
                                    <div class="form-group mb-4">
                                        ...
                                        <input id="ar_engineer_name" type="text"
                                            class="form-control @error('ar_engineer_name') is-invalid @enderror"
                                            name="ar_engineer_name" value="{{ old('ar_engineer_name') }}" required
                                            autocomplete="ar_engineer_name">
                                    ...
                                    <div class="form-group mb-4">
                                        ...
                                        <input id="en_location" type="text"
                                            class="form-control @error('en_location') is-invalid @enderror"
                                            name="en_location" value="{{ old('en_location') }}" required
                                            autocomplete="en_location">
                                    ...
                                    <div class="form-group mb-4">
                                        ...
                                        <input id="ar_location" type="text"
                                            class="form-control @error('ar_location') is-invalid @enderror"
                                            name="ar_location" value="{{ old('ar_location') }}" required
                                            autocomplete="ar_location">
                                    ...
                                    <div class="form-group mb-4">
                                        ...
                                        <input id="en_client" type="text"
                                            class="form-control @error('en_client') is-invalid @enderror"
                                            name="en_client" value="{{ old('en_client') }}" autocomplete="en_client">
                                    ...
                                    <div class="form-group mb-4">
                                        ...
                                        <input id="ar_client" type="text"
                                            class="form-control @error('ar_client') is-invalid @enderror"
                                            name="ar_client" value="{{ old('ar_client') }}" autocomplete="ar_client">
