    ...
    <div class="col">
      ...
      <form action="{{ route('comments.store') }}" method="POST" id="newArticleForm">
        ...
        <div class="form-group">
            ...
            <input type="text" name="title" class="form-control @error('title') is-invalid @enderror" id="newArticleTitle" value="{{ old('title') }}" >
            @error('title')
        ...
        <div class="form-group">
            ...
            <textarea class="form-control @error('content') is-invalid @enderror" name="content" id="newArticleContent" rows="3" >{{ old('content') }}</textarea>
            @error('content')
            <span class="invalid-feedback" role="alert">
                <strong>{{ $message }}</strong>
            </span>
