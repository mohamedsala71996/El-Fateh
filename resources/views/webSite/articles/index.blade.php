  ...
  <div class="container">
    <div class="cards m-auto gap-4 row" style="align-items: center; justify-content: center; ">
      ...
      box-shadow: 0px 0px 10px 0px #0000000D !important;">
        <img src="assets/images/Articles1.jpg" class="card-img-top" style="height: 300px; padding-top:10px ;" alt="card image">
        <div class="card-body">
      ...
      box-shadow: 0px 0px 10px 0px #cca3a30d !important;">
        <img src="assets/images/Articles2.jpg" class="card-img-top" style="height: 300px; padding-top:10px ;" alt="card image">
        <div class="card-body">
          <p class="card-text">بعض الأمثلة السريعة للنصوص التي يمكن البناء عليها على عنوان البطاقة وتشكل الجزء الأكبر من البطاقة
            محتوى.</p>
      ...
      <div class="cards  col-lg-5 col-md-6 col-12" style="width: 20rem; margin: 10px; border: 1px solid #000000 !important;
      box-shadow: 0px 0px 10px 0px #0000000D !important;">
        <img src="assets/images/Articles3.jpg" class="card-img-top" style="height: 300px;padding-top:10px ;" alt="card image">
        <div class="card-body">
          <p class="card-text">بعض الأمثلة السريعة للنصوص التي يمكن البناء عليها على عنوان البطاقة وتشكل الجزء الأكبر من البطاقة
            محتوى.</p>
          <div class="d-flex flex-column align-items-center">
      ...
      <div class="cards  col-lg-5 col-md-6 col-12" style="width: 20rem; margin: 10px; border: 1px solid #000000 !important;
      box-shadow: 0px 0px 10px 0px #0000000D !important;">
        <img src="assets/images/Articles4.jpg" class="card-img-top" style="height: 300px; padding-top:10px ;" alt="card image">
        <div class="card-body">
          <p class="card-text">بعض الأمثلة السريعة للنصوص التي يمكن البناء عليها على عنوان البطاقة وتشكل الجزء الأكبر من البطاقة
            محتوى.</p>
          <div class="d-flex flex-column align-items-center" id="app">
      ...
      <div class="cards  col-lg-5 col-md-6 col-12" style="width: 20rem; margin: 10px; border: 1px solid #000000 !important;
      box-shadow: 0px 0px 10px 0px #cca3a30d !important;">
        <img src="assets/images/Articles5.jpg" class="card-img-top" style="height: 300px; padding-top:10px ;" alt="card image">
        <div class="card-body">
          <p class="card-text">بعض الأمثلة السريعة للنصوص التي يمكن البناء عليها على عنوان البطاقة وتشكل الجزء الأكبر من البطاقة
            محتوى.</p>
          <div class="d-flex flex-column align-items-center">
      ...
      <div class="cards  col-lg-5 col-md-6 col-12" style="width: 20rem; margin: 10px; border: 1px solid #000000 !important;
      box-shadow: 0px 0px 10px 0px #0000000D !important;">
        <img src="assets/images/Articles6.jpg" class="card-img-top" style="height: 300px;padding-top:10px ;" alt="card image">
        <div class="card-body">
          <p class="card-text">بعض الأمثلة السريعة للنصوص التي يمكن البناء عليها على عنوان البطاقة وتشكل الجزء الأكبر من البطاقة
            محتوى.</p>
          <div class="d-flex flex-column align-items-center">
