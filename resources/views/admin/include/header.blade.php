            ...
            <ul class="header-right justify-content-end d-flex align-items-center mb-0">
                        ...
                        <div class="dropdown-menu rounded-4 shadow border-0 p-0" data-bs-popper="none">
                            <div class="card">
                                <div class="list-group list-group-custom" style="width: 200px;">
                                    ...
                                    <a href="#" class="list-group-item"><span class="flag-icon flag-icon-eg me-2"></span>العربيه</a>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <li>
                    <div class="dropdown morphing scale-left user-profile mx-lg-3 mx-2">
                        ...
                        <img class="avatar img-thumbnail rounded-circle shadow" src="{{ url('/') }}/admin/assets/img/profile_av.png" alt="">
                        </a>
                        <div class="dropdown-menu border-0 rounded-4 shadow p-0">
                            <div class="card border-0 w240">
                                <div class="card-body border-bottom d-flex">
                                <img class="avatar rounded-circle" src="{{ url('/') }}/admin/assets/img/profile_av.png" alt="">
                                    <div class="flex-fill ms-3">
                                        <h6 class="card-title mb-0">Allie Grater</h6>
                                        <span class="text-muted"><a href="/cdn-cgi/l/email-protection" class="_cf_email_" data-cfemail="3f5e5353565a584d5e4b5a4d7f534a5150115c5052">[email&#160;protected]</a></span>
                                    </div>
                                </div>
                                <div class="list-group m-2 mb-3">
                                    <a class="list-group-item list-group-item-action border-0" href="page-profile.html">
                                        <i class="w30 fa fa-user"></i>My Profile
                                    </a>
                                    <form id="logout-form" action="{{ route('logout.admin') }}" method="POST" style="display: none;">
                                        @csrf
                                    </form>
                                    {{-- <a href="./auth-signin.html" class="btn bg-secondary text-light text-uppercase rounded-2">Sign out</a> --}}
